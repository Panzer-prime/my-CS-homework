...
int main() {
    ...
    creare(cap);
    afisare(cap);
    cout<<"introdu valuare noua: "; cin>>valoareNoua;
    nod* element = cap->urm;
    inserareDupaUnElement(cap, element, valoareNoua);

    cout<<"ce pozitie va fi cautata: "; cin>>pozitieCautata;
    cautareDupaPozitie(cap, pozitieCautata);

    cout<<"ce valoare va fi cautata: "; cin>>valoareCautata;
    cautareDupaVal(cap, valoareCautata);
    cout<<"introdu valoare pe care o vom sterge: "; cin>>pozitieDeSters;
    cout<<"\nafisarea inaite de stergere ";
    afisare(cap);
    cout<<"\nafisarea dupa stergere ";
    stergereaDupaPozitie(cap, pozitieDeSters);
    afisare(cap);
    cout<<"Introdu valoare pe care o vom sterge "; cin>>valoareDeSters;
    cout<<"\nafisarea inaite de stergere";
    afisare(cap);
